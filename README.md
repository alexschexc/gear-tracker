...
| **Chronograph integration & ballistics calculator** | Extend reload log to capture velocity strings (up to 40 shots) and automatically compute kinetic energy, TKO, ES, SD, and average velocity for load validation and hunting effectiveness assessment.[web:179][web:180][web:194][web:199] | User enters shot strings (velocities in fps); GearTracker computes statistics and displays energy/TKO using bullet weight and diameter from the reload batch. Limit of 40 shots provides headroom beyond the statistically ideal 20–30 shot strings.[web:194][web:196] All calculations done locally with no external APIs. | Beta 2 |
